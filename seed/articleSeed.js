...
async function seedDB() {
  ...
  try {
    ...
    const articleData = [
      {
        imageCover: 'https://res.cloudinary.com/racmathafidz/image/upload/v1636344438/Recruiting_zonsbo.png',
      ...
      {
        imageCover: 'https://res.cloudinary.com/racmathafidz/image/upload/v1636344451/Surtido_opb7zc.png',
      ...
      {
        imageCover: 'https://res.cloudinary.com/racmathafidz/image/upload/v1636344461/Management_itbxty.png',
